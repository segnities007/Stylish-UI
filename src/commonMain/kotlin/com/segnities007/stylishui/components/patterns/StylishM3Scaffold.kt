...
@Composable
@Deprecated(
    "Use StylishScaffold (the overlay-based modern scaffold) instead.",
    ReplaceWith("StylishM3Scaffold(modifier, topBar = header, content = content)"),
)
public fun StylishM3Scaffold(
...
@Composable
private fun StylishM3ScaffoldPreview() {

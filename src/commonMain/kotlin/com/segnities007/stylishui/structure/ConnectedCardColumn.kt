 ...
 * computed automatically from each item's index: the first card rounds only its
 * top corners, the last card rounds only its bottom corners, and middle cards
 ...
 * counterpart `StylishConnectedCardColumn` consumes by supplying a styled
 * [card]. Supply your own [card] to render a custom skin over the same
 * connected geometry.
 *

 ...
 * horizontal outlines. The actual rendering is delegated to the [listItem]
 ...
 * backbone that the Stylish Finish counterpart `StylishConnectedListItemColumn`
 ...
 *   item data, a modifier, the connected [Shape], the outline [ConnectedEdges],
 *   and the outline [ConnectedCorners].
 *

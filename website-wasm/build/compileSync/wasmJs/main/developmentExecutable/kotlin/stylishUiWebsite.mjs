...
import { importObject, setWasmExports } from './stylishUiWebsite.import-object.mjs'
...
const wasmFilePath = './stylishUiWebsite.wasm';
...
try {
  ...
  if (isBrowser) {
    wasmInstance = (await WebAssembly.instantiateStreaming(fetch(new URL('./stylishUiWebsite.wasm',import.meta.url).href), importObject, wasmOptions)).instance;
  }
} catch (e) {
